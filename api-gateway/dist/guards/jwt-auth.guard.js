    ...
    async canActivate(context) {
        ...
        try {
            ...
            if (!authHeader || !authHeader.startsWith('Bearer ')) {
                throw new common_1.UnauthorizedException('Missing or invalid token format');
            }
            ...
            try {
                const decodedToken = await (0, rxjs_1.firstValueFrom)(this.userClient.send('validate_token', { token }));
                request.user = {
